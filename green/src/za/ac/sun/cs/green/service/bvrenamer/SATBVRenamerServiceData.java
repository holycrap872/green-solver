...
public class SATBVRenamerServiceData extends BasicService{
	
	private static final String BVRENAMED = "BVRENAMED";
	private static final String BVRENAMED_INSTANCES = "BVRENAMED_INSTANCES";
	...
	public SATBVRenamerServiceData(Green solver){
		super(solver);
	}
...
//				System.out.println("Rename Time: "+(System.nanoTime() - time));
	...
	public Object allChildrenDone(Instance instance, Object result) {
		...
		@SuppressWarnings("unchecked")
		Set<Instance> ret = (Set<Instance>) original.getData(BVRENAMED_INSTANCES);
		if (ret == null) {
			ret = new HashSet<Instance>();
		}
		ret.addAll(factors);
		original.setData(BVRENAMED_INSTANCES, ret);
